            ...
            <div class="bg-ketiga rounded-lg shadow-md p-8 mt-8 max-w-4xl mx-auto">
                <div class="flex">
                    ...
                    <div class="md:w-2/3 md:ml-8 mt-10">
                        ...
                        <p class="mb-4">Lokasi Perbaikan : Stasiun Sidareja</p>
                        <p class="mb-4">Ditujukkan Kepada : Manager Bangunan dan Asisten Manajer Stasiun</p>
                        ...
                        <p class="mb-4">Sumber Laporan : RDS</p>
                    </div>
                </div>
                <!-- Galeri Gambar -->
