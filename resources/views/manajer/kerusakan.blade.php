                                    ...
                                    <tr class="bg-white">
                                        ...
                                        <td class="px-5 py-5 border border-gray-200 text-sm text-center">
                                            <div class="flex justify-center space-x-2">
                                                <button onclick="updateStatus('{{ route('kerusakan.approve', $k) }}', this)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-500" viewBox="0 0 20 20" fill="currentColor">
                                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 00-1.414 0L8 12.586 4.707 9.293a1 1 0 00-1.414 1.414l4 4a1 1 0 001.414 0l8-8a1 1 0 000-1.414z" clip-rule="evenodd" />
                                                    </svg>
                                                </button>
                                                <button onclick="updateStatus('{{ route('kerusakan.reject', $k) }}', this)">
                        ...
                        <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                            ...
                            <div>
                                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                                    ...
                                    @foreach ($kerusakan->links() as $page)
                                        @if ($page['active'])
                                            <span class="relative inline-flex items-center bg-indigo-600 px-4 py-2 text-sm font-semibold text-white ring-1 ring-inset ring-gray-300">{{ $page['label'] }}</span>
                                        @else
                                            <a href="{{ $page['url'] }}" class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 ring-1 ring-inset ring-gray-300 hover:bg-gray-50">{{ $page['label'] }}</a>
                                        @endif
                                    @endforeach
